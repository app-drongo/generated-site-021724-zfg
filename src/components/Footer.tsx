...
// Generated: 2025-08-19T22:36:40.508Z
// Section: footer
// Category: footer
...
export default function Footer() {
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "Industry Expertise", href: "/services#industry" }
      ]
    },
    {
      title: "Company",
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Client Portal", href: "/resources#portal" }
      ]
    },
    {
      title: "Legal",
  ...
  const socialLinks = [
    ...
    { name: "LinkedIn", icon: Linkedin, href: "https://linkedin.com/company/acmeconsulting" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Acme Consulting is a leading professional services firm, helping organizations navigate complex challenges and unlock their full potential. With a focus on strategy, digital transformation, and operational excellence, we empower our clients to achieve sustainable growth and success.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button size="sm" className="px-3 bg-primary text-primary-foreground hover:bg-primary/80">
                  <ArrowRight className="size-4" />
                </Button>
              </div>
              <p className="text-xs text-muted-foreground">
                Get the latest updates and insights from Acme Consulting. Unsubscribe anytime.
              </p>
            </div>
          </div>
