...
// Generated: 2025-08-19T22:36:40.609Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Our team of experienced consultants will help you navigate the complexities of the modern business landscape and unlock your organization's full potential.
            </p>
