...
// Generated: 2025-08-19T22:36:40.358Z
// Section: navigation
// Category: navigation
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button size="sm" className="group bg-primary text-primary-foreground hover:bg-primary/80">
              Get Started
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t">
            ...
            <div className="pt-4 flex flex-col space-y-2">
              ...
              <Button className="justify-start group bg-primary text-primary-foreground hover:bg-primary/80">
                Get Started
                <ArrowRight className="ml-2 size-4 transition-transform group-hover:translate-x-1" />
              </Button>
            </div>
